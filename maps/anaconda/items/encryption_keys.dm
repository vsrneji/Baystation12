...
/obj/item/device/encryptionkey/anaconda_exploration
	name = "exploration radio encryption key"
	icon_state = "srv_cypherkey"
	channels = list("Exploration" = 1)

/obj/item/device/encryptionkey/anaconda_headset_pilot
	name = "pilot radio encryption key"
	icon_state = "srv_cypherkey"
	channels = list("Exploration" = 1, "Supply" = 1, "Science" = 1)

/obj/item/device/encryptionkey/anaconda_headset_mining
...
/obj/item/weapon/storage/box/encryptionkey/exploration
	...
	startswith = list(/obj/item/weapon/screwdriver, /obj/item/device/encryptionkey/anaconda_exploration = 5)

/obj/item/device/encryptionkey/anaconda_el
