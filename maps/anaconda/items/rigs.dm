...
/obj/item/clothing/head/helmet/space/rig/command
	...
	icon = 'maps/anaconda/icons/obj/solgov-head.dmi'
	item_icons = list(slot_head_str = 'maps/anaconda/icons/mob/solgov-head.dmi')
...
/obj/item/clothing/suit/space/rig/command
	icon = 'maps/anaconda/icons/obj/solgov-suit.dmi'
	item_icons = list(slot_wear_suit_str = 'maps/anaconda/icons/mob/solgov-suit.dmi')
	species_restricted = list(SPECIES_HUMAN)

/obj/item/clothing/shoes/magboots/rig/command
	icon = 'maps/anaconda/icons/obj/solgov-feet.dmi'
	item_icons = list(slot_shoes_str = 'maps/anaconda/icons/mob/solgov-feet.dmi')
	species_restricted = list(SPECIES_HUMAN)

/obj/item/clothing/gloves/rig/command
	icon = 'maps/anaconda/icons/obj/solgov-hands.dmi'
	item_icons = list(slot_gloves_str = 'maps/anaconda/icons/mob/solgov-hands.dmi')
	species_restricted = list(SPECIES_HUMAN)
