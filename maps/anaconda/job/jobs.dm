...
#define HUMAN_ONLY_JOBS /datum/job/captain, /datum/job/hos
	species_to_job_blacklist = list(
		...
		/datum/species/resomi  		 = list(HUMAN_ONLY_JOBS, /datum/job/officer),
...
#undef HUMAN_ONLY_JOBS
	...
	allowed_jobs = list(/datum/job/captain, /datum/job/first_mate,
						/datum/job/engineer,
						/datum/job/officer,
						/datum/job/doctor, /datum/job/scientist,
