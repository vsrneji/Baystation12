//Makes sure we don't get any merchant antags as a balance concern. Can also be used for future anaconda specific antag restrictions.
...
/datum/antagonist/ert/equip(var/mob/living/carbon/human/player)
	...
	var/decl/hierarchy/outfit/ert_outfit = outfit_by_type((player.mind == leader) ? /decl/hierarchy/outfit/job/anaconda/ert/leader : /decl/hierarchy/outfit/job/anaconda/ert)
