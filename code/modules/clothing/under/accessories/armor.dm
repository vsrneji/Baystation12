...
/obj/item/clothing/accessory/armorplate/merc
	...
	/obj/item/clothing/accessory/armorplate/ablative
	name = "ablative plate"
	desc = "A armor plate made of steel-reinforced synthetic fibers with ablative cover. Attaches to a plate carrier."
	icon_state = "armor_tactical"
